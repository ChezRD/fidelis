...
class SNP_NHP_Options_upload extends SNP_NHP_Options
{
	...
	echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="snp-nhp-opts-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Upload', Redux_TEXT_DOMAIN) . '</a>';
	echo ' <a href="javascript:void(0);" class="snp-nhp-opts-upload-remove button-secondary"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove Upload', Redux_TEXT_DOMAIN) . '</a>';
