...
{
    // default connection
    public static $dbname = 'fidelis'; // Your database name
    public static $dbuser = 'xcrud234'; // Your database username
    public static $dbpass = 'kwabena03'; // // Your database password
    public static $dbhost = 'aws-rds-apeb.cff0v2jjph3v.eu-west-1.rds.amazonaws.com'; // Your database host, 'localhost' is default.
